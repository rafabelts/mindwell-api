...
var ReviewService = /** @class */ (function () {
    function ReviewService() {
        this.repository = repositoryFactory_1.RepositoryFactory.getRepository('review');
    }
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.repository.addReview(review)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
    ...
    ReviewService.prototype.getReviews = function (id, type) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, tryCatchHelper_1.tryCatchHelper)(function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this.repository.getReviews(id, type)];
                                case 1:
                                    reviews = _a.sent();
                                    if (!reviews)
