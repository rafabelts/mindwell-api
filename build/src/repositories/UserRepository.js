...
var UserRepository = /** @class */ (function () {
    ...
    UserRepository.prototype.addUser = function (userData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, tryCatchHelper_1.tryCatchHelper)(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, db_1.db.insert(schema_1.user).values(userData)];
                                case 1:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, db_1.db.query.user.findFirst({
                                        where: function (user) { return (0, drizzle_orm_1.eq)(user.id, id); },
                                    })];
                                case 1:
                                    user = _a.sent();
                                    if (!user) {
